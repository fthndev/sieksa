...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="flex justify-end gap-3 mt-6">
        <a
            href="{{route('pj.download_excel', ['absensi' => $data_absensi->id_absensi, 'ekstra' => $data_absensi->id_ekstrakurikuler])}}" 
            class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg shadow-sm transition">
            Cetak
        </a>
        <a 
            href="{{ url()->previous() }}" 
            class="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-4 py-2 rounded-lg shadow-sm transition">
            Kembali
        </a>
    </div>
</div>
