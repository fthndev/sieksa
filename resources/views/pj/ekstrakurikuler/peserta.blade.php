...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('pj.dashboard') }}" {{-- Atau route lain yang relevan --}}
               class="px-4 py-2 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-md hover:bg-slate-300 dark:hover:bg-slate-600 transition">
                            ...
                            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                                <thead class="bg-slate-50 dark:bg-slate-700">
                                    <tr>
                                        ...
                                        {{-- Tambahkan kolom aksi jika perlu, misal hapus peserta dari ekskul (oleh PJ) --}}
                                    </tr>
                                </thead>
