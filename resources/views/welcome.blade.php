    ...
    <main class="flex-grow">
        ...
        <section class="py-16 lg:py-24 bg-gray-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300">
            <div class="container mx-auto px-6 lg:px-8">
                ...
                @php
                    $daftar_ekstrakurikuler = \Illuminate\Support\Facades\DB::table('detail_absensi')
                                                        ->get();
                    $extracurriculars = [
                        ['title' => 'English Course', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" /></svg>', 'description' => 'Asah logika dan kreativitasmu dalam merancang dan membangun robot. Belajar pemrograman, mekanika, dan elektronika dasar.' ],
                        ['title' => 'Tarbiyatul Aroby', 'icon' => '<svg class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg/arabic"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"></path></svg>', 'description' => 'Tingkatkan kemampuan berpikir kritis dan berbicara di depan umum. Persiapkan diri untuk kompetisi dan diskusi global.' ],
                        ['title' => 'Projek Karya Inovasi  ', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z" /></svg>', 'description' => 'Salurkan bakat musikmu! Belajar instrumen, olah vokal, dan berkolaborasi dalam grup musik.' ],
                        ['title' => 'Dormitory IT', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>', 'description' => 'Abadikan momen dan ceritakan kisah melalui lensa kamera. Pelajari teknik pengambilan gambar, editing, dan sinematografi.' ],
                        ['title' => 'Banjari', 'icon' => '<svg class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path></svg>', 'description' => 'Abadikan momen dan ceritakan kisah melalui lensa kamera. Pelajari teknik pengambilan gambar, editing, dan sinematografi.' ],
                        ['title' => 'Qiroatul Qur`an', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-red-600 dark:text-red-500 mb-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" /></svg>','description' => 'Abadikan momen dan ceritakan kisah melalui lensa kamera. Pelajari teknik pengambilan gambar, editing, dan sinematografi.' ],
                    ];
                @endphp
