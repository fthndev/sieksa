    ...
    <x-slot name="navbar_ekstra">
            <div class="flex justify-center sm:justify-start space-x-4 pt-1 gap-5">
                <div class="w-20 {{ request()->routeIs('musahil.detail_ekstra') ? 'border-b-4 border-b-blue-600 rounded-b-sm' : '' }} flex justify-center p-1">
                    <a href="{{ route('musahil.detail_ekstra', ['ekstrakurikuler' => $pengguna->id_ekstrakurikuler]) }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600">Forum</a>
                </div>
                ...
                <div class="w-20 {{ request()->routeIs('musahil.daftar_orang_ekstra') ? 'border-b-4 border-b-blue-600 rounded-b-sm' : '' }} flex justify-center p-1">
                    <a href="{{ route('musahil.daftar_orang_ekstra', ['ekskul' => $pengguna->id_ekstrakurikuler]) }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600">Orang</a>
                </div>
            </div>
    </x-slot>
